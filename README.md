...
기본 실행은 `http://localhost:8501/?demo=1&capture=1` 데모 화면을 사용한다. 상세 옵션과 GitHub Actions 산출물 구조는 [docs/ui_capture.md](docs/ui_capture.md)를 참고한다.
